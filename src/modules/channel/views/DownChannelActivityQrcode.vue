<template>
  <el-dialog width="400px" :visible="visible" append-to-body :before-close="onClose">
    <div>
      ...
      >
        <p>{{ target.title }}</p>
        <i class="el-icon-close" style="position:absolute;right:10px;top:8px;font-size:20px;cursor: pointer;" @click="onClear(1)" />
      </div>
    ...
    <div style="margin:40px 0">
      ...
      >
        ...
        <i class="el-icon-close" style="position:absolute;right:10px;top:8px;font-size:20px;cursor: pointer;" @click="onClear(2)" />
      </div>
