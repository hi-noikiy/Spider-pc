<template>
  <div>
    ...
    <el-form class="form" :model="model" ref="model" label-width="135px" label-position="left" size="small">
      ...
      >
        <el-input
          v-model.number="model.activityCommissionFrozenHours"
          type="age"
          style="width: 100px;"
        ></el-input><span style="margin-left:10px;color:#606266">天</span>
      </el-form-item>
      ...
      >
        <el-input
          v-model.number="model.courseCommissionFrozenHours"
          type="age"
          style="width: 100px;"
        ></el-input><span style="margin-left:10px;color:#606266">天</span>
      </el-form-item>
      ...
      >
        <el-input
          v-model.number="model.orderCommissionFrozenHours"
          type="age"
          style="width: 100px;"
        ></el-input><span style="margin-left:10px;color:#606266">天</span>
