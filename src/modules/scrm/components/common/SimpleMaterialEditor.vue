      ...
      <div class="edit-content" :style="`height: ${materialType === 'text' ? 155 : 190}px`">
        <template v-if="materialType === 'text'">
          ...
          <div class="btn-group" v-if="false">
            ...
            <!-- <el-button-group v-if="fromMaterial">
            ...
            <div class="btn-group" v-if="fromMaterial">
              <el-button-group>
                ...
                <!-- <el-button type="primary" size="small" icon="el-icon-folder-opened" @click="showSelectionDialog"
                  >从图文素材中选择</el-button
                > -->
                <el-button type="primary" size="small" @click="showRadarSelectionDialog">从雷达中选择</el-button>
              </el-button-group>
            </div>
            ...
            <div class="program-box">
              ...
              <div class="box-content">
                <img
                  ...
                  :src="`${imgHost}${program.form.imageUrl}`"
                  fit="cover"
                  alt=""
                />
        ...
        <template v-if="materialType === 'file'">
          <div class="upload-content" v-if="file.form.file === ''">
            ...
            <div class="btn-group" v-if="fromMaterial">
              <el-button-group>
                <el-button type="primary" size="small" icon="el-icon-folder-opened" @click="showRadarSelectionDialog">从雷达中选择</el-button>
              </el-button-group>
            </div>
          </div>
    ...
    <com-dialog :config="selectionDialog.config" @closeDialog="selectionDialog.config.visible = false">
      <div class="selection-content">
        ...
        <div class="selection-pagination">
          <com-pagination :page="selectionDialog.page" @sizeChange="onSelectionSizeChange" @pageChange="onSelectionPageChange"></com-pagination>
        </div>
      ...
      <div class="selection-content">
        <div class="selection-table">
          ...
          >
            ...
            <el-table-column label="链接标题" prop="linkTitle" align="center" v-if="materialType === 'image_text'"></el-table-column>
            <el-table-column label="文件名称" prop="fileName" align="center" v-if="materialType === 'file'"></el-table-column>
        ...
        <div class="selection-pagination">
          <com-pagination :page="radarDialog.page" @sizeChange="onRadarSizeChange" @pageChange="onRadarPageChange"></com-pagination>
        </div>
