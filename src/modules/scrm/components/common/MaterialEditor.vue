  ...
  <div class="material-editor">
    ...
    <div class="edit-content">
      <template v-if="materialType === 'text'">
        <div>
          <el-input v-model="text.form.content" type="textarea" placeholder="请输入话术内容" show-word-limit> </el-input>
        </div>
      ...
      <div class="dialog-content">
        <el-form :model="imageText.form" :rules="rules" ref="imageTextModel" label-position="right" label-width="auto">
          ...
          <el-form-item label="描述" prop="content">
            <el-input v-model="imageText.form.content" placeholder="请输入链接描述" clearable> </el-input>
          </el-form-item>
      ...
      imageTextColumn: [
        ...
        },
        {
          ...
          formatter: row => {
            return (
              <div>
                <a style="color: #294a7b;" href={row.link} target="_blank">{row.link}</a>
              </div>
            )
          }
        },
