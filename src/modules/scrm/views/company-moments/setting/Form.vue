      ...
      <div class="module">
        ...
        <div class="config">
          <el-form label-position="right" label-width="180px">
            <el-form-item :label="nameConfig.name" :rules="[{ required: true, message: '该项为必填项' }]">
              <el-input v-model="nameConfig.value" style="width: 200px" maxlength="5" show-word-limit></el-input>
            ...
            <el-form-item :label="titleConfig.name" :rules="[{ required: true, message: '该项为必填项' }]">
              <el-input v-model="titleConfig.value" style="width: 200px" maxlength="5" show-word-limit></el-input>
