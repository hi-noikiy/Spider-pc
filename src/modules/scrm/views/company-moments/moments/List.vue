<template>
  <div class="container">
    <div class="query-table-box">
      <el-button size="small" type="primary" @click="addMoments">新增企业动态圈</el-button>
      <div class="search-content">
        <el-form inline :model="searchForm" label-width="100px" label-position="right" size="small">
          <el-form-item label="动态内容">
            <el-input placeholder="请输入动态内容" v-model="searchForm.content" @input="searchMoments"></el-input>
          </el-form-item>
        </el-form>
      </div>
    </div>
    ...
    <div class="common-table-box">
      ...
      >
        <el-table-column label="动态内容" align="left">
        ...
        <el-table-column label="发表成员" prop="userNameList" align="center" width="400px">
          <template slot-scope="scope">
        ...
        <el-table-column label="发布时间" prop="pushTime" align="center">
          <template slot-scope="scope">
        ...
        <el-table-column label="操作" align="center">
          <template slot-scope="scope">
            <el-button type="text" v-if="!scope.row.status" @click="publishMoments(scope.row.id)">发布</el-button>
            <el-button type="text" v-if="!scope.row.status" @click="editMoments(scope.row.id)">修改</el-button>
            <el-button type="text" v-if="scope.row.status" @click="getMomentsDetail(scope.row.id)">详情</el-button>
                ...
                {row.status ? (
                  <div>
                    <el-button
                      type="text"
                      onClick={() => {
                        this.$router.push(`/main/scrm/moments/detail?id=${row.id}`)
                      }}
                    >
                      详情
                    </el-button>
