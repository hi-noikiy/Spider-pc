<template>
  <div class="radar-form">
    <div class="top-nav">
      <el-button type="text" icon="el-icon-arrow-left" @click="$router.go(-1)">{{ $route.query.id ? '修改' : '新建' }}雷达</el-button>
    </div>
    <div class="container">
      <div class="module">
        ...
        <div class="content">
          ...
          <div class="content-form">
            <el-form ref="form" :model="form" label-width="80px">
              ...
              >
                <el-input placeholder="名称不会展示给用户，用于企业记录渠道名称或使用场景" v-model="form.title" maxlength="60" show-word-limit></el-input>
              </el-form-item>
              <el-form-item label="文件类型" :required="true">
                ...
                <div class="radar-link" v-if="form.type == 'link'">
                  ...
                  >
                    <el-form-item label="链接标题">
                      <el-input placeholder="请输入链接标题" v-model="form.linkTitle" clearable maxlength="60" show-word-limit></el-input>
                    </el-form-item>
                    <el-form-item label="链接描述">
                      <el-input placeholder="请输入链接描述" v-model="form.linkAbstract" clearable maxlength="120" show-word-limit></el-input>
                    </el-form-item>
                    <el-form-item label="链接地址">
                      <el-input placeholder="请输入链接地址" v-model="form.link" clearable maxlength="256" show-word-limit></el-input>
                    </el-form-item>
                    <el-form-item label="链接封面">
                      ...
                      <div class="image-wrap" v-else>
                        <el-image class="link-cover" :src="`${imgHost}${form.linkCover}`" :preview-src-list="[`${imgHost}${form.linkCover}`]"></el-image>
                ...
                <div class="radar-file" v-if="form.type == 'file'">
                  ...
                  <div class="upload-content" v-if="!form.fileUrl || form.fileUrl === ''">
                    ...
                    <div class="cont-tips">文件最大20MB，支持文件格式: pdf / doc / docx / xls / xlsx / txt / ppt / pptx</div>
                  </div>
                  ...
                  <div class="file-describe">
                    <span>文件简介</span>
                    <el-input placeholder="请输入文件简介(选填)" v-model="form.fileDescribe" maxlength="256" show-word-limit></el-input>
                    <el-tooltip
                      effect="dark"
                      placement="right"
...
export default {
  components: {
    ImageUpload, ComDialog, FileUpload
  },
  data() {
    return {
      form: {
  ...
  methods: {
    ...
    fileUploadSuccess(file) {
      ...
      this.form.fileUrl = file.address
    ...
    submitRadarForm() {
      ...
      if (this.form.type === 'link') {
        if (this.form.linkTitle === '') {
          ...
          return
        } else if (this.form.linkAbstract === '') {
