<template>
  <div class="enterprise-tag">
    <div class="container">
      ...
      <div class="table-info">
        <div class="info-left">
          ...
          <div class="info-msg">
            ...
            <el-button type="text" @click="openWhatTag">何为行为标签?</el-button>
          </div>
        </div>
        <div class="info-right">
          <el-button size="small" type="primary" @click="addTagGroup">添加标签组</el-button>
        </div>
      </div>
      <div class="common-table-box">
        ...
        >
          ...
          <el-table-column label="标签组名称" prop="name" align="center"> </el-table-column>
          <el-table-column label="标签内容" align="center" class="special-column" width="700px">
          ...
          <el-table-column label="排序号" prop="sequence" align="center"> </el-table-column>
    ...
    <com-dialog :config="editDialog.config" @closeDialog="editDialog.config.visible = false" class="dialogSelect">
      <el-form label-position="right" label-width="auto" ref="eidtExtendModel" :model="models" class="el-form-filter">
        ...
        <div class="addtag-item">
          ...
          <div class="addtag-input">
            ...
            <el-row :gutter="24" v-for="(item, index) in models.tagList" :key="index">
              <el-col :span="16">
                <el-input
                  placeholder="请输入标签名"
                  maxlength="15"
              ...
              <el-col :span="6">
                <el-input placeholder="请输入分值" v-model="models.tagList[index].score"></el-input>
              </el-col>
              <el-col :span="2"> <i class="el-icon-minus iconMinu" @click="deteleEditRow(item.id)"></i></el-col>
            </el-row>
          </div>
        </div>
      </el-form>
      <div class="addtag-addBtn"><el-button type="text" @click="addEditKeyWord()"> 添加标签</el-button></div>
      <div class="Btn-two">
        <el-row :gutter="24">
          <el-col :span="10"
            ><el-button type="text" style="color:red;" @click="deteleTagGroup()">删除标签组</el-button></el-col
          >
    ...
    <com-dialog :config="addTagDialog.config" @closeDialog="addTagDialog.config.visible = false" class="dialogSelect">
      <el-form label-position="right" label-width="auto" ref="addExtendModel" :model="model" class="el-form-filter">
        <el-form-item label="标签组名称">
          <el-input placeholder="请输入标签组名称" maxlength="15" show-word-limit v-model="model.name"></el-input>
        </el-form-item>
        <div class="addtag-item">
          <div class="addtag-title">
            标签<el-button class="addtag-tagbtn" @click="whatDialog.config.visible = true" type="text"
              >分值的作用&gt;</el-button
            >
          </div>
          <div class="addtag-input">
            ...
            <el-row :gutter="24" v-for="(item, index) in model.tagList" :key="index">
              <el-col :span="16">
                <el-input placeholder="请输入标签名" maxlength="15" v-model="item.name"></el-input>
              </el-col>
              <el-col :span="6"><el-input placeholder="请输入分值" v-model="item.score"></el-input></el-col>
              <el-col :span="2"> <i class="el-icon-minus iconMinu" @click="deteleRow(index)"></i></el-col>
            </el-row>
          </div>
          <div class="addtag-addBtn"><el-button type="text" @click="addKeyWord()"> 添加标签</el-button></div>
        </div>
      </el-form>
      <div>
    ...
    <com-dialog :config="whatDialog.config" @closeDialog="whatDialog.config.visible = false" class="dialogSelect">
      <div class="what-message" v-for="(whatmessage, whatIndex) in whatMessage" :key="whatIndex">
        {{ whatmessage.message }}
      </div>
      <div class="what-btn">
        <el-row :gutter="24">
          ...
          <el-col :span="11"
            ><el-button class="what-bottom-btn" type="primary" @click="whatDialog.config.visible = false"
              >知道了</el-button
            ></el-col
          >
          <el-col :span="6">&nbsp;</el-col>
