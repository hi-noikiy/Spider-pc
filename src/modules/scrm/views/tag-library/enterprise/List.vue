<template>
  <div class="enterprise">
    <!-- 顶部导航 -->
    <TabButton :navList="navList" @change="changeNavBarFun"></TabButton>
    <!-- 列表内容 -->
    <div class="middle_content">
      <div class="enterprise_list" v-show="navBarFlag == 0">
        <div class="btns_content">
          <div class="nums">目前已有企业标签：{{ enterpriseSearch.total }}</div>
          <div class="btns">
            <el-button type="primary" size="mini" @click="addEnterpriseTagGroup">添加标签组</el-button>
            <el-button type="primary" size="mini" @click="refreshEnterpriseTag">标签同步</el-button>
          </div>
        </div>
        <div class="table">
          <template>
            ...
            >
              <el-table-column prop="name" label="标签组名称" align="center"></el-table-column>
              <el-table-column prop="tagList" label="标签内容" align="center" width="800">
              ...
              <el-table-column prop="groupTime" label="新增时间" align="center">
                <template slot-scope="scope">
              ...
              <el-table-column label="操作" align="center">
                <template slot-scope="scope">
                  <div>
                    <el-button type="text" @click="showEnterpriseEditDialog(scope.row)">修改</el-button>
                    <el-button type="text" @click="deteleEnterpriseTagGroup(scope.row.groupId)">删除</el-button>
                  </div>
                </template>
              </el-table-column>
            </el-table>
      ...
      <div class="behavior_list" v-show="navBarFlag == 1">
        <div class="btns_content">
          <div class="nums">目前已有行为标签：{{ behaviorSearch.total }}</div>
          <div class="btns">
            <el-button type="primary" size="mini" @click="addBehaviorTagGroup">添加标签组</el-button>
          </div>
        </div>
        <div class="table">
          <template>
            ...
            >
              ...
              <el-table-column label="操作" align="center">
                <template slot-scope="scope">
                  <div>
                    <el-button type="text" @click="showBehaviorEditDialog(scope.row)">修改</el-button>
                    <el-button type="text" @click="deteleBehaviorTagGroup(scope.row.id)">删除</el-button>
                  </div>
                </template>
              </el-table-column>
            </el-table>
    ...
    >
      ...
      >
        ...
        <div class="addtag-item">
          ...
          <div>
            <el-button @click="addEnterpriseEditKeyWord" plain icon="el-icon-plus" size="small">添加标签</el-button>
          </div>
        </div>
      </el-form>
    ...
    >
      ...
      >
        ...
        <div class="addtag-item">
          ...
          <div>
            <el-button @click="addBehaviorKeyWord" plain icon="el-icon-plus" size="small">添加标签</el-button>
          </div>
        </div>
      </el-form>
      <div></div>
      <div class="Btn-two" style="display: flex; justify-content: flex-end">
        ...
        <el-button type="primary" @click="sumbitBehaviorAddDialog()">确定</el-button>
      </div>
    </com-dialog>
    <!-- 编辑标签组 -->
    <com-dialog
    ...
    >
      ...
      >
        ...
        <!-- <div class="addtag-item">
          <div class="addtag-title">标签</div>
          <div class="addtag-input">
            <el-row :gutter="24" v-for="(item, index) in behaviorEditModel.tagList" :key="index">
              <el-col :span="16">
                <el-input
                  placeholder="请输入标签名"
                  maxlength="15"
              ...
              <el-col :span="2"> <i class="el-icon-minus iconMinu" @click="deteleBehaviorEditRow(item.id)"></i></el-col>
            </el-row>
          </div>
        </div> -->
        <div class="addtag-item">
          <div class="addtag-title">标签</div>
          <div class="addtag-input">
            <div class="addtag-input-content" v-for="(item, index) in behaviorEditModel.tagList" :key="index">
              <div class="inp">
                <el-input
                  placeholder="请输入标签名"
                  maxlength="15"
              ...
              <div class="btn">
                <el-button circle icon="el-icon-minus" @click="deteleBehaviorEditRow(item.id)" size="mini"></el-button>
              </div>
            </div>
          </div>
          <div>
            <el-button @click="addBehaviorEditKeyWord" plain icon="el-icon-plus" size="small">添加标签</el-button>
          </div>
        </div>
      </el-form>
      ...
      <div class="footer_btns" style="display: flex; justify-content: flex-end">
        ...
        <el-button type="primary" @click="sumbitBehaviorEditDialog()">确定</el-button>
      </div>
    </com-dialog>
  </div>
</template>
...
export default {
  components: { ComPagination, ComDialog, TabButton },
  data() {
    return {
      // 导航列表
      navList: [
