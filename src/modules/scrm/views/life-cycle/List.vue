  ...
  <div class="container">
    <div class="life-cycle-info">
      ...
      <div class="top_search">
        <div class="info-top">
          <el-button type="primary" @click="goToDetailPage" size="small">客户生命周期设置</el-button>
          <el-button type="primary" @click="exportExcel" size="small">导出客户（{{ count }}位）</el-button>
    ...
    >
      <div class="setting-dialog">
        ...
        <div class="query-table-box">
          <el-form inline :model="listSearch" label-width="70px" label-position="right" size="small">
            <el-form-item label="备注名">
              <el-input size="small" v-model="listSearch.remarks" placeholder="请输入备注名"></el-input>
            </el-form-item>
            <el-form-item label="手机号">
              <el-input size="small" v-model="listSearch.mobile" placeholder="请输入手机号"></el-input>
            </el-form-item>
            <el-form-item label="客户标签">
              <div class="query-table-title" @click="showTagsDialog()">
                <span class="query-table-choose" v-if="selectedTags.length == 0">请选择</span>
            ...
            <el-form-item label="成员">
              <div class="query-table-title" @click="showMemberDialog">
                <span class="query-table-choose" v-if="selectedMembers.length == 0">请选择</span>
        ...
        <div class="com-table-box">
          ...
          <el-table :data="noLifeCycleList" width="100%" height="400">
            <el-table-column label="序号" type="index" align="center" width="100px"></el-table-column>
            <el-table-column label="客户姓名" prop="name" align="center" minWidth="120px"></el-table-column>
            <el-table-column label="头像" prop="avatar" align="center" minWidth="120px">
              <template slot-scope="scope">
                <img :src="scope.row.avatar" alt="" width="44" height="44" />
              </template>
            </el-table-column>
            <el-table-column label="性别" prop="gender" align="center" minWidth="120px">
              <template slot-scope="scope">
                <div>{{ scope.row.gender === 0 ? '未知' : scope.row.gender === 1 ? '男' : '女' }}</div>
              </template>
            </el-table-column>
            <el-table-column label="手机号码" prop="mobile" align="center" minWidth="120px"></el-table-column>
            <el-table-column label="添加时间" prop="createTime" align="center" minWidth="160px">
              <template slot-scope="scope">
            ...
            <el-table-column label="操作" align="center" min-width="160px">
              <template slot-scope="scope">
                <div class="select-item">
                  <div class="select-content">
                    <el-select v-model="settingList[scope.$index].customerLifeCycleId" placeholder="未设置" clearable>
                      <el-option
    ...
    >
      <div class="tag-dialog">
        ...
        <div class="tag-list">
          <div class="tag-group" v-for="(item, index) in enterpriseTagList" :key="index">
  ...
  methods: {
    ...
    getLifeCycleUsers() {
      this.$http.getCustomerLifeCycleUsers(this.search).then((res) => {
        this.lifeCycleUsers = res.data.data
      })
    },
    // 获取生命周期阶段列表
    getLifeCycleList() {
    ...
    goToDetailPage() {
      this.$router.push(`/main/scrm/life-cycle/detail`)
    },
    // 选择企业标签弹窗
    showTagsDialog() {
