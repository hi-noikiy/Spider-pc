    ...
    <div class="addlivecode">
      <div class="container">
        <div class="operating-btn">
          <el-button type="primary" @click="openAddKeyword" size="small">新增关键词</el-button>
        </div>
        <el-form inline :model="searchForm" label-width="100px" label-position="right" size="small">
          <el-form-item label="关键词名称" style="margin-bottom: 0px">
            <el-input
      ...
      <div class="common-table-box">
        ...
        >
          ...
          <el-table-column label="关键词名称" prop="keywordName" align="center"> </el-table-column>

          <el-table-column label="关键字" align="center" class="special-column" width="500px">
            <template slot-scope="scope">
              <div>
                <span v-for="(item, index) in scope.row.keywordList" :key="index">{{ item.keyword }}，</span>
              </div>
            </template>
          </el-table-column>
          <el-table-column label="新增人" align="center" prop="createBy"> </el-table-column>
          <el-table-column label="新增时间" prop="createTime" align="center">
            <template slot-scope="scope">
              {{scope.row.createTime | allTableTimefilters}}
            </template>
          </el-table-column>
          <el-table-column label="操作" align="center" :formatter="formatterColumn" width="165px"> </el-table-column>
        </el-table>
      </div>
      ...
      <com-dialog :config="selectionDialog.config" @closeDialog="selectionDialog.config.visible = false">
        <div class="editDiv">
          <el-form ref="models" :model="models" label-position="left" label-width="100px">
          ...
          <el-form-item label="图片">
            ...
            <div class="content-div">
              <div v-for="answerItem in models.answerList" :key="answerItem.id">
        ...
        <div class="Btn-two" style="display: flex; justify-content: flex-end">
          ...
          <el-button type="primary" @click="onEditSave()">确定</el-button>
        </div>
      </com-dialog>
      <!-- <el-dialog
    ...
    >
      ...
      <div class="editDiv">
        <el-form ref="models" :model="models">
          ...
          <el-form-item label="文字描述" prop="imageUrl">
            <el-input v-model="models.answerList[0].content"></el-input>
          </el-form-item>
