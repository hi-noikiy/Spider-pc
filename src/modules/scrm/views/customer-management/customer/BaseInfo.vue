        ...
        <el-form-item :label="item.name" v-for="(item, index) in updateList.extendList" :key="index">
          ...
          <div class="radio" v-if="item.type == 'radio'">
            <el-radio-group v-model="item.value">
              <el-radio :label="value" v-for="(value, key) in item.optionName" :key="key">{{ value }}</el-radio>
            </el-radio-group>
          </div>
          <div class="checkbox" v-if="item.type == 'checkbox'">
            <el-checkbox-group v-model="item.value">
              <el-checkbox :label="value" v-for="(value, key) in item.optionName" :key="key">{{ value }}</el-checkbox>
            </el-checkbox-group>
          </div>
        </el-form-item>
  ...
  methods: {
    ...
    */
    ...
    success() {
      ...
      this.updateNewField(options, (res) => {
