    ...
    <div class="main_content">
      ...
      <div class="group_members">
        ...
        <com-pagination
          ...
          @sizeChange="onGroupMembersSizeChange"
          @pageChange="onGroupMembersPageChange"
        ></com-pagination>
      </div> -->
...
export default {
  ...
  methods: {
    ...
    getPageCustomerList(options) {
      ...
      // options.pageNum = this.GroupMembersPageData.pageNum
      this.$http.getPageCustomerList(options).then((res) => {
        console.log('666', res)
        this.GroupMembersTableData = res.data.data
        // this.GroupMembersPageData.total = res.data.data.total
