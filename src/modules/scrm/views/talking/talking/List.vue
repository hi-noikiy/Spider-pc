<template>
  <div class="talking">
    <div class="container">
      ...
      <!-- 分类列表start -->
      <main v-show="!isSearchForm" class="talking-m">
        <div class="tabs">
          <div
            class="tabs-item"
      ...
      <div class="speech-dialog">
        <div class="speech_dialog_content">
          ...
          <el-form label-width="120px" label-position="left">
            ...
            <!-- 图文雷达相关start -->
            <el-form-item label="雷达追踪" v-if="['image_text'].includes(materialEditor.type) && !imageTextRadarSetting.isFromRadar">
              <div class="radar-content">
                <el-checkbox v-model="imageTextRadarSetting.isRadar" :disabled="isImageTextDisabledFn">同步到雷达链接</el-checkbox>
                <el-tooltip
                  effect="dark"
                  placement="right"
            ...
            <el-form-item label="雷达信息" v-if="['image_text'].includes(materialEditor.type) && imageTextRadarSetting.isFromRadar">
              <div class="radar-setting">
                ...
                <div class="setting-tags" v-if="imageTextRadarSetting.form.isBehaviorTag">
                  <el-tag type="info" class="tag-item" v-for="(item, index) in imageTextRadarSetting.form.behaviorTagList" :key="index">{{item.name}}</el-tag>
                </div>
              </div>
            </el-form-item>
            <!-- 图文雷达相关end -->
            <!-- 文件雷达相关start -->
            <el-form-item label="雷达追踪" v-if="['file'].includes(materialEditor.type) && !fileRadarSetting.isFromRadar">
              <div class="radar-content">
                <el-checkbox v-model="fileRadarSetting.isRadar" :disabled="isFileDisabledFn">同步到雷达链接</el-checkbox>
                <el-tooltip
                  effect="dark"
                  placement="right"
                  content="使用雷达链接发送，可追踪链接打开记录"
            ...
            <el-form-item label="雷达信息" v-if="['file'].includes(materialEditor.type) && fileRadarSetting.isFromRadar">
              <div class="radar-setting">
                <div class="setting-item">
                ...
                <div class="setting-tags" v-if="fileRadarSetting.form.isBehaviorTag">
                  <el-tag type="info" class="tag-item" v-for="(item, index) in fileRadarSetting.form.behaviorTagList" :key="index">{{item.name}}</el-tag>
                </div>
              </div>
            </el-form-item>
            <!-- 文件雷达相关end -->
