    ...
    <div class="main_content">
      ...
      <div class="top_search">
        <el-button
          type="primary"
          size="small"
          @click="$router.push('/main/scrm/operation-management/welcomemessage/details')"
          >新建欢迎语</el-button
        >
      </div>
      <!-- 表格 -->
      <div class="table_content">
        <el-table
          ...
          :height="tableHeight"
        >
          <el-table-column prop="message" label="消息内容" width="400">
          ...
          <el-table-column prop="userNameList" label="使用成员" width="400" align="center">
            <template slot-scope="scope">
          ...
          <el-table-column prop="avatar" label="操作" align="center">
            <template slot-scope="scope">
              <el-button
                type="text"
                @click="$router.push('/main/scrm/operation-management/welcomemessage/details?id=' + scope.row.id)"
                >修改</el-button
              >
              <el-button type="text" @click="deleteUserWelcome(scope.row.id)">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
      ...
      <div class="page_content">
        <com-pagination :page="pageData" @sizeChange="onSizeChange" @pageChange="onPageChange"></com-pagination>
      </div>
    </div>
