  ...
  <div class="addlivecode">
    <div class="container">
      <div class="query-table-box">
        <el-form inline :model="searchForm" label-width="70px" label-position="left" size="small">
          <div class="form_content">
            <div class="left">
              <el-form-item class="import-item">
                <el-button size="small" type="primary" @click="openAddLiveCode" class="import-excel-float"
                  >导入Excel</el-button
                >
              </el-form-item>
            </div>
      ...
      <div class="common-table-box">
        ...
        >
          ...
          <el-table-column label="分配人员" align="center" class="special-column" width="500px">
          ...
          <el-table-column label="已添加人数/总人数" align="center">
            <template slot-scope="scope">
              <div>
          ...
          <el-table-column label="操作" align="center" :formatter="formatterColumn" width="165px">
            <template slot-scope="scope">
              <div>
                <el-button type="text" @click="readDetails(scope.row.id)">详情</el-button>
                <el-button type="text" @click="remindFriend(scope.row.id)">提醒</el-button>
                <!-- <el-button type="text" @click="detailsFriend(scope.row.id)">详情</el-button> -->
                <el-button type="text" @click="deleteFriend(scope.row.id)">删除</el-button>
              </div>
            </template>
          </el-table-column>
        </el-table>
    ...
    <com-dialog :config="importExcel.config" @closeDialog="importExcel.config.visible = false">
...
export default {
  components: { ComPagination, ComDialog, DepartmentDialog },
  data() {
    return {
      action: '',
  ...
  methods: {
    ...
    downloadExcel() {
      this.$nextTick(() => {
        ...
        FileSaver.saveAs(this.imgHost + '/attachments/scrm/87ca1bb12d25416992d097d9df6a1dd8.xls' , 'Excel批量添加好友模板.xls')
