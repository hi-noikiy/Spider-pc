...
<template>
  <div class="department" ref="table">
    <div class="top">
      <div class="search">
      ...
      <div class="reload">
        <el-button type="primary" @click="addPoater"><i class="el-icon-plus"></i>添加海报</el-button>
      </div>
    </div>
    <div class="content">
      <div class="left">
      ...
      <div class="right">
        ...
        >
          <div class="picbox" v-if="posterlist.length > 0">
            <div class="contentbox" v-for="(item, i) in posterlist" :key="i">
  ...
  methods: {
    ...
    savePhones(){
      ...
      if(this.modeltitle=='添加一级分类'){
        ...
        let params = {name:this.newChild.name,sequence:this.newChild.sequence,superiorId:this.row.id,type:'poster'}
        this.creatTree(params)
