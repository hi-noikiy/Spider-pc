  ...
  <div>
    <div class='searchtop'>
      <div class='topbox'>
        ...
        <el-input placeholder="请输入" width="200px" v-model='pageData.name'></el-input>
      </div>
      <div class='topbox'>
    ...
    <div class='centerbox'>
      <div style='display:flex;justify-content:space-between'>
        <div style='display:flex;'>
          <h1>离职继承</h1>
          <span style='color:#999;font-size:14px;margin-left:10px'>从通讯录将离职员工删除后，可以分配他的客户及客户群给其他员工继续跟进</span>
        </div>
        <!-- <div>
      ...
      >
        ...
        <el-table-column prop="name" label="已离职员工" width="130" align="center"></el-table-column>
        <el-table-column prop="deptName" label="所属部门" width="160" align="center"> </el-table-column>
        ...
        <el-table-column prop="unallocatedCustomer" label="待分配客户数" width="140" align="center"> </el-table-column>
        <el-table-column prop="unallocatedGroup" label="待分配群聊数" width="140" align="center"> </el-table-column>
        <el-table-column prop="resignTime" label="离职时间" align="center"> </el-table-column>
        <el-table-column label="操作"  align="center">
          <template slot-scope="scope">
            <el-button type='text' @click="godetail(scope.row.wxUserId)">明细</el-button>
          </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    // 查看明细
    godetail(id){
      this.$router.push('./leaveDetail?wxUserId='+id)
    },
    // 时间
    getDatePicker(e){
