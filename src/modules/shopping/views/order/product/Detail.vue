<template>
  <div class="product-order-detail">
    <div class="product-order-detail__status">
      ...
      <div>
        <el-button size="small" @click="orderCompensationVisible = true" v-if="isStoreRole && compensationStatus.showCompensationApply"
          >申请赔付</el-button
        >
        <el-button
      ...
      <div class="info-plate">
        <QcTextPlate title="收货人信息">
          ...
          <el-button
            ...
            v-if="model.status == '待发货' && isStoreRole">修改收货信息</el-button>
        </QcTextPlate>
      </div>
      <div class="info-plate">
    ...
    <div class="product-order-detail__product">
      ...
      <div class="total-plate">
        <QcTextPlate>
          ...
          <QcTextPlateItem label="店铺优惠券：" v-if="model.storeCouponPayAmount"><span class="total-plate-span">-￥{{ model.storeCouponPayAmount | formatPrice }}</span></QcTextPlateItem>
