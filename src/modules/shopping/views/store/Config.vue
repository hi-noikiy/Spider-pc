<template>
  <el-form label-position="left" label-width="120px" style="width:300px">
    <el-form-item :label="model.name">
      <el-input v-model="model.value" style="width:140px"></el-input>&nbsp;元
    </el-form-item>
    <el-form-item>
      <el-button type="primary" @click="updateConfigItem()">保存</el-button></el-form-item
    >
  </el-form>
</template>
