<template>
  <div>
    <QcTable :search-form="searchForm" :menu="menu" :option="option" :column="column"></QcTable>
    <el-dialog
      :show-close="false"
      title="证书详情"
      ...
      append-to-body
    >
      <el-form label-position="right" label-width="120px" :model="certificate.model" ref="model">
        ...
        >
          <QcImageUpload v-model="certificate.model.iconUrl" width="350px" height="248px"></QcImageUpload>
            ...
            return (
              <div>
                <el-popover placement="bottom" width="300" trigger="click">
                  ...
                  <el-button type="primary" type="text" slot="reference">
                    首页链接
                  </el-button>
                </el-popover>
                <el-button
                ...
                {row.isCheck ? (
                  <el-button
                    type="text"
                    onClick={this.certificateStatusUpdate.bind(this, row.id, false)}
                  >
                    关闭
                  </el-button>
                ) : (
                  <el-button
                    type="text"
                    onClick={this.certificateStatusUpdate.bind(this, row.id, true)}
                  >
                    开启
                  </el-button>
                )}
