<template>
  <div class="wrap" ref="wrap" v-loading="dataLoading">
      ...
      <el-form class="form" :model="model" ref="base" label-position="left" label-width="100px" size="small">
        ...
        <el-form-item>
          <el-form :inline="true" label-position="top" style="margin-left: 20px;">
            <el-form-item label="显示LOGO" prop="bgImgUrl" :rules="[{ required: false, message: '该字段不能为空'}]" style="margin-right: 20px;">
    ...
    <el-dialog title="选择活动" width="65%" :visible.sync="dialogTable" @close="closeDialogTable" :append-to-body="true" :close-on-click-modal="false" :close-on-press-escape="false">
      <div style="border: 1px solid #ebeef5;">
        ...
        <qc-table-old v-if="dialogTable" ref="table" :table-list="showData" :search="searchData" :autoHeight="500" style="padding-bottom: 50px;" url="api/admin/v1/activity/page"></qc-table-old>
      </div>
