...
export default {
  data() {
    return {
      option: {
        url: this.$route.query.showType == 3
      ...
      menu: [
        {
          label: "兑奖",
          type: 'primary',
          disabled: ({ currentRow }) => this.$route.query.showType == 3 || currentRow.id == undefined || currentRow.checkStatus != 'new',
          on: (currentRow) => {
      ...
      searchForm: [
        { value: this.$route.query.id, 
          formName: this.$route.query.showType == 3 ? "id" : "lotteryId" },
        {
          label: "奖项",
          type: "select",
        ...
        },
        {
          ...
          formatter: row => {
            switch (row.checkStatus) {
              ...
              default: return row.checkStatus
            }
          },
          width: "150px"
        },
