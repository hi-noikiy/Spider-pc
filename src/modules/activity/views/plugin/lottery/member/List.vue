<template>
  <div class="wrap" ref="wrap">
    <div ref="search">
      <button-wrap>
        <el-button v-if="$route.query.showType == 1" type="primary" size="mini" @click="openForm()" :disabled="selectionList.length === 0">指定中奖</el-button>
        <el-button v-if="$route.query.showType == 1" type="primary" size="mini" @click="deleteConfirm()" :disabled="selectionList.length === 0">取消指定中奖</el-button>
        <up-load-file v-if="$route.query.sourceType == 3" :id="$route.query.id" :data="{id: $route.query.id}" title="导入" url="api/admin/v1/lottery/import" @file-success="fileSuccess"></up-load-file>
        <el-button type="primary" size="mini" @click="back">返回</el-button>
      </button-wrap>
    </div>
    <table-box :tableData="signData.tableData" :propData="signData.propData" :page="signData.page" @get-selection="getSelection" @current-change="handleCurrentChange" @size-change="handleSizeChange" :loading="loading" v-if="sourceType === 1"></table-box>
    <table-box :tableData="checkData.tableData" :propData="checkData.propData" :page="checkData.page" @get-selection="getSelection" @current-change="handleCurrentChange" @size-change="handleSizeChange" :loading="loading" v-if="sourceType === 2"></table-box>
    <table-box :tableData="numberData.tableData" :propData="numberData.propData" :page="numberData.page" @get-selection="getSelection" @current-change="handleCurrentChange" @size-change="handleSizeChange" :loading="loading" v-if="sourceType === 3"></table-box>
    <dig-form :visible="digFormWrap" :itemList="detail.itemList" :selectionList="selectionList" @close="digClose"></dig-form>
