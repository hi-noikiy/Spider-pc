  ...
  methods: {
    ...
    jumpPage(type) {
      switch(type) {
        case 1:
          // 参与嘉宾
          this.$router.push(`/main/activity/plugin/lottery/member?id=${this.tableRow.id}&sourceId=${this.tableRow.sourceId}&sourceType=${this.tableRow.sourceType}`)
          break;
        case 2:
          // 中奖名单
          this.$router.push(`/main/activity/plugin/lottery/winning?id=${this.tableRow.id}&showType=${this.tableRow.showType}`)
          break;
        case 3:
          // 查看弹幕
