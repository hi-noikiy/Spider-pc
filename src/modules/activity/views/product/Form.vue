<template>
  <div class="wrap" ref="wrap" v-loading="dataLoading" element-loading-text="加载中...">
    <Tabbar :tab-list="tabbar" :active-index="activeIndex" :on-change="handleSelect"></Tabbar>
    <div class="context-box" :style="{'height': `${areaHeight}px`}" ref="context">
      <el-button v-if="false" @click="getTestData()">填充测试数据</el-button>
      <div v-show="activeIndex === 1">
          ...
          <el-form :model="model" ref="base" label-position="top" size="small">
            ...
            <el-form-item style="margin-bottom: 0;">
              <el-form-item
                ...
                class="inline right"
              >
                <el-select v-model="model.categoryId" placeholder="请选择分类">
                  <el-option
                    :label="item.name"
                    :value="item.id"
              ...
              <el-form-item label="标签" class="inline right" placeholder="请选择标签">
                <el-select v-model="model.activityTagLists" multiple>
                  <el-option :label="item.name" :value="item.id" v-for="(item, i) in tag" :key="i"></el-option>
                </el-select>
                <el-button type="text" @click="digTagFormWrap = true">新增</el-button>
              </el-form-item>
              <el-form-item
                label="序号"
                prop="seqNum"
                ...
                placeholder="请输入序号"
              >
                <el-input-number v-model="model.seqNum" :min="0" :max="10000"></el-input-number>
              </el-form-item>
            </el-form-item>

            <el-form-item label="主办方" v-if="false">
              <el-input
            ...
            <el-form-item label="承办方" v-if="false">
              <el-input
            ...
            <el-form-item label="城市" v-if="false">
              <el-input
                v-model="model.city"
                style="width:400px;"
                :maxlength="16"
            ...
            <el-form-item label="活动地点" v-if="false">
              <el-input
                v-model="model.place"
                style="width:400px;"
                :maxlength="16"
            ...
            <el-form-item
              ...
              :rules="[{ required: true, message: '该字段不能为空'}]"
            >
              <div class="upload-img-box" @click="showImgBox(true, 'iconUrl', true)">
        ...
        <div class="setting">
          ...
          <el-form :model="model" ref="time" label-position="top">
            <el-form-item
              label="活动时间"
              prop="startTime"
              :rules="[{ required: true, message: '该字段不能为空'}]"
        ...
        <div class="setting">
          ...
          <el-form :model="model.activitySignSetting" ref="signNum" label-position="top">
            <el-form-item>
              <el-form-item
                label="最大人数"
                prop="maxNum"
        ...
        <div class="setting">
          ...
          <el-form :model="model" label-position="top">
            <el-form-item>
              <el-switch v-model="model.isEnableFee" active-text="开启付费"></el-switch>
            </el-form-item>
        ...
        <div class="setting">
          ...
          <el-form :model="model" ref="model" label-position="top">
            <el-form-item>
              ...
              <div v-if="model.activitySignSetting.isEnableWxTemplateRemind">
                <el-form-item label="活动开始前提前多少分钟提醒">
                  ...
                  <span
                    ...
                    v-if="model.activitySignSetting.aheadTime && model.startTime && model.activitySignSetting.remaindTime"
          ...
          <table cellpadding="0" cellspacing="0" class="act-table">
            <tbody>
              ...
              <tr v-for="(item, i) in model.signDataSettingList" :key="i">
                ...
                <td>
                  <el-input v-model="item.name" size="mini" style="width: 150px;"></el-input>
                </td>
                <!-- <td>
                ...
                <td>
                  <el-button type="danger" size="mini" @click="delDataSetting(i)">删除</el-button>
                </td>
              </tr>
      ...
      <div v-show="activeIndex === 3">
        ...
        <div v-if="model.isEnableCheckin">
          ...
          <div
            class="setting"
            v-if="model.activityCheckinSetting.checkinCode || model.activityCheckinSetting.isEnableMobileCheckin || model.activityCheckinSetting.isEnableAirborne"
          >
    ...
    <login-dialog :visible="digLogin" @close="closeLogin" :is-again="isAgain"></login-dialog>
    <edit-image
      :visible="digImgWrap"
      image-type="activity"
  ...
  methods: {
    ...
    getMobileUrl() {
      this.$http.getMobileUrl().then(res => {
        this.shareHost =
          res.data.data.url + '/mobile/POUND/activity/detail?wo=1&wot=2&woacm=1&mpl=1&'
      })
    },
    // 输入提前多少分钟提醒
    numberChange() {
    ...
    getActivity(id, state) {
      this.$http
        ...
        .then(res => {
          ...
          data.activityCheckinSetting.isCheckinCode = data.activityCheckinSetting.checkinCode
            ? true
            : false
          ...
          if (this.model.activityFee.vipPrice)
            this.model.activityFee.vipPrice = this.model.activityFee.vipPrice / 100
    ...
    check() {
      ...
      let thisResult = this.utils.compareTime(
        this.model.activitySignSetting.signEndTime,
        this.model.endTime
      )
      if (!thisResult) {
      ...
      if (
        this.model.activitySignSetting.isEnableAudit &&
        this.model.activitySignSetting.isEnableWxTemplateRemind
      ) {
    ...
    submit(state) {
      ...
      if (model.activityFee.vipPrice)
        model.activityFee.vipPrice = Math.floor(model.activityFee.vipPrice * 100)
