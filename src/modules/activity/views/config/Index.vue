<template>
  <div class="wrap" v-loading="dataLoading">
    ...
    <div style="padding:30px 0;">
      ...
      <div style="width: 320px;padding: 5px 10px 10px;margin-top: 10px;font-size: 14px;line-height: 1.5;color: #777;background: #F5F5F5;">
    ...
    <FormTypeTitle text="报名成功订阅消息ID">
      <el-button type="primary" size="small" :loading="configSignSubscribe.loading" @click="saveSignSubscribe()">保存</el-button>
    </FormTypeTitle>
    <el-form class="form" :model="configSignSubscribe" ref="configSignSubscribe" label-position="left" label-width="106px" size="small">
    ...
    saveSignSubscribe() {
      this.$refs.configSignSubscribe.validate(valid => {
        if (valid) {
          ...
          this.$http[apiName](this.configSignSubscribe).then(() => {
