<template>
  <div>
    <div class="header_nav">
      <el-button type="text" icon="el-icon-arrow-left" @click="$router.go(-1)">{{$route.query.id ? '修改' : '新建'}}图文</el-button>
    </div>
    ...
    <div class="main_content">
      <el-form :model="model" ref="model" label-position="left" label-width="110px">
        ...
        >
          <el-input type="number" :min="0" v-model="model.readPoint" style="width: 400px" clearable></el-input>
        </el-form-item>
