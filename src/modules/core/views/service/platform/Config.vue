      ...
      <div class="config-item">
        ...
        <div class="config-item__container">
          <div class="config-item__container-info">
            ...
            >
              开启微信支付
              <el-switch @change="updateAppWechatConfig()" v-model="wechatConfig.isOpenWxPay"></el-switch>
            </div>
            <div style="display: flex;justify-content: space-between;align-items: center;width: 170px;">
              开启微信支付协议
              <el-switch @change="updateAppWechatConfig()" v-model="wechatConfig.isOpenWxPayAgreement"></el-switch>
            </div>
          </div>
          <div class="config-item__container-menu">
            <el-button type="text" @click="$router.push('/main/service/setting/pay')">添加支付</el-button>
          </div>
        </div>
      </div>
    </QcTitle>
      ...
      <div class="config-item">
        ...
        <div class="config-item__container">
          ...
          <div class="config-item__container-menu">
            ...
            <el-button type="text" v-if="showAuthStore === '1'" @click="authorizeStore()">授权店铺小程序</el-button>
          </div>
        </div>
      </div>
    </QcTitle>
      ...
      <div class="config-item">
        ...
        <div class="config-item__container">
          <div class="config-item__container-info">
            ...
            <QcImageUpload v-model="wechatConfig.wechatSubscribeQrcode" width="100px" height="100px"></QcImageUpload>
          </div>
          <div class="config-item__container-menu"></div>
        </div>
      </div>
    </QcTitle>
    <el-dialog title="修改平台信息" append-to-body :visible.sync="wechatConfigVisible" width="500px">
...
export default {
  ...
  computed: {
    showAuthStore() {
      if (this.$store.state.showAuthStore === null || this.$store.state.showAuthStore === undefined) {
