  ...
  <div style="background:#fff">
    <div class="context-box" ref="context">
      <div v-show="activeIndex === 1">
        ...
        <ul class="ad-list">
          <li>
            <img src="./img/i_weixin.png" alt="">
            <p class="title">无缝对接微信生态</p>
            <p class="tips">完美融入微信生态，提供安逸的报名体验</p>
          </li>
          <li>
            <img src="./img/i_jishu.png" alt="">
            <p class="title">稳定的技术服务</p>
            <p class="tips">完美融入微信生态，提供安逸的报名体验</p>
          </li>
          <li>
            <img src="./img/i_pinpai.png" alt="">
        ...
        <ul class="version-list">
          <li>
            <div class="top" style="background-color: #6ca4e8;">
              <p class="title">基础版</p>
              ...
              <el-button class="btn" size="medium" @click="pay(1)">购 买</el-button>
            </div>
            <div class="bottom">
              <p class="bottom-title">产品服务</p>
              <ul>
                <li v-for="(item, i) in model.version_1.info" :key="i">{{item}}</li>
              </ul>
            </div>
          </li>
          <li>
            <div class="top" style="background-color: #417fc8;">
            ...
            <div class="bottom">
              <p class="bottom-title">产品服务</p>
              <ul>
                <li v-for="(item, i) in model.version_2.info" :key="i">{{item}}</li>
              </ul>
            </div>
          </li>
          <li>
            <div class="top" style="background-color: #2161ad;">
              <p class="title">企业版</p>
              ...
              <el-button class="btn" size="medium" @click="pay(3)">购 买</el-button>
            </div>
            <div class="bottom">
              <p class="bottom-title">产品服务</p>
              <ul>
                <li v-for="(item, i) in model.version_3.info" :key="i">{{item}}</li>
              </ul>
            </div>
          </li>
        </ul>
