<template>
  ...
  >
    <el-image mode="cover" class="qc-mall-single__banner" :src="imgHost + options.cover">
      <div slot="error" class="el-image__error" style="min-height:150px">请上传图片，建议尺寸345*150</div>
    </el-image>
  ...
  config: [
    ...
    { formName: 'bottomRadio', label: '底部圆角', type: 'el-switch', value: false },
    {
      ...
      props: {
        ...
        type: ['product'],
        max: 1,
        propsName: 'id,name,price,origPrice'
      }
    }
  ]
}
