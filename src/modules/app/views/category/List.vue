    ...
    <el-dialog :visible="visible" title="应用信息" append-to-body width="450px" :show-close="false">
      ...
      >
        ...
        <el-form-item
          label="图标"
          prop="iconUrl"
          :rules="[{ required: false, message: '请填写该字段' }]"
        >
          <ImageUpload
    ...
    return {
      ...
      column: [
        { label: '序号', type: 'index', align: 'center' },
        {
          ...
          formatter: row => {
            return (
              <el-image src={this.imgHost + row.iconUrl} style="width:60px;height:60px;"></el-image>
            )
          }
        },
            ...
            return (
              <div>
                <el-button
                  ...
                  type="text"
                  onClick={this.getAppCategory.bind(this, row.id)}>
                  修改
                </el-button>
                <el-dropdown>
                  <el-button type="text">
