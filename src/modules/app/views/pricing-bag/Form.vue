<template>
  <QcNavigationPage content="套餐定价">
    ...
    >
      ...
      <el-form-item label="描述" prop="describe" :rules="[{required:true,message:'请填写该字段'}]">
      ...
      <el-form-item label="售价">
        ...
        <div class="price-wrap" v-for="(item,index) in model.pricingBagPriceList" :key="index">
          <el-form-item
            ...
            :rules="[{required:true,message:'请填写该字段'},{message:'金额格式不正确',pattern: regPrice}]"
          >
          ...
          <el-form-item
            ...
            :rules="[{required:true,message:'请填写该字段'},{message:'请填写正整数',pattern: /^\d+$/}]"
          >
